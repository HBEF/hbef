...
sensor_grab_map <- c('NO3_N_mg' = 'NO3_N',
                     'TempC' = 'temp',
                     'SpConductivity' = 'spCond',
                     'pH' = 'pH')

#sensor unit map 
sensor_unit_map <- c('NO3_N_mg' = 'mg/L',
                     'TempC' = 'C',
                     'Conductivity' = 'uS/cm',
                     'SpConductivity' = 'uS/cm',
                     'pH' = '',
                     'DepthMeter' = 'm',
                     'ODOPerCent' = '',
                     'ODOMGL' = '',
...
sensor_name_map <- c('NO3_N_mg' = 'NO3-N',
                     'TempC' = 'Temperature',
                     'Conductivity' = 'Conductivity',
                     'SpConductivity' = 'SpConductivity',
                     'pH' = 'pH',
                     'DepthMeter' = 'Depth',
                     'ODOPerCent' = 'ODOPerCent',
                     'ODOMGL' = 'ODOMGL',
                     'TurbidityFNU' = 'TurbidityFNU',
                     'TurbidityRaw' = 'TurbidityRaw',
                     'FDOMRFU' = 'FDOMRFU',
                     'FDOMQSU' = 'FDOMQSU',
                     'LowEOSCO2_ppm_avg' = 'LowEOSCO2_ppm_avg',
                     'HighEOSCO2_ppm_avg' = 'HighEOSCO2_ppm_avgv',
                     'EOSTempC' = 'EOSTempC',
                     'Chl_RFU' = 'Chl_RFU',
                     'BGA_PC_RFU' = 'BGA_PC_RFU',
                     'BGA_PE_RFU' = 'BGA_PE_RFU',
                     'AqCO2_ppm_avg' = 'AqCO2_ppm_avg',
                     'AtmCO2_ppm_avg' = 'AtmCO2_ppm_avg')
