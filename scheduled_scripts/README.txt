...
process_unh_data.R and process_S.CAN_data.R must run as cron tasks. process_unh_data.R must run first, because it begins by dropping the sensor4 table that they both use.
