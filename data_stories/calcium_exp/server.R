...
#Function for calculating the biomass per species.
...
#Function for inserting biomass breaks to create biomass bins
#and renaming the rows and columns.
...
#Creating the data frames for ggplot2
