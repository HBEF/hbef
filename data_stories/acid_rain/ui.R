  ...
  fluidPage(theme = "Solar_bootstrap.min.css",
            ...
            fluidRow(column(width = 8, offset = 1,
                            h3("Starting in the early 1950s (soon after Disney first released Cinderella 
                                     ...
                                     on the ecosystems."),
                            h3('"But plants and animals need the rain and snowmelt to survive" you 
                                     say.  Yes, point for you.  Though the precipitation at this time was 
            ...
            fluidRow(column(width = 11, offset = 1,
                            #                    selectInput("cmpdSelect", "Choose a compoundto graph",
                            #                               choices = c("Ca" = "Ca",
                            #                                          "Mg" = "Mg",
                            #                                         "K" = "K",
                            #                                        "Na" = "Na",
