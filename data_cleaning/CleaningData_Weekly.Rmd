...
precip_streamflow_weekly_data_long %>% 
  saveRDS(file = "precip_streamflow_weekly_data_long.rds")
...
fixed <- c("ws","date","water_date","water_year", "source", "water_mm", "granularity", "solute", "datetime", "canonical")
values <- colnames(df[, !(names(df) %in% fixed)])

precip_streamflow_weekly_data_wide <- data.table::dcast(data.table::setDT(df), ws + date + water_date + water_year + source + water_mm + granularity ~ solute, value.var = values)
...
precip_streamflow_weekly_data_wide %>% 
  saveRDS(file = "precip_streamflow_weekly_data_wide.rds")
...
diff_ws1_w <- get_differencef(precip_streamflow_weekly_data_long, "1", "week")
diff_ws2_w <- get_differencef(precip_streamflow_weekly_data_long, "2", "week")
diff_ws3_w <- get_differencef(precip_streamflow_weekly_data_long, "3", "week")
diff_ws4_w <- get_differencef(precip_streamflow_weekly_data_long, "4", "week")
diff_ws5_w <- get_differencef(precip_streamflow_weekly_data_long, "5", "week")
diff_ws6_w <- get_differencef(precip_streamflow_weekly_data_long, "6", "week")
diff_ws7_w <- get_differencef(precip_streamflow_weekly_data_long, "7", "week")
diff_ws8_w <- get_differencef(precip_streamflow_weekly_data_long, "8", "week")
diff_ws9_w <- get_differencef(precip_streamflow_weekly_data_long, "9", "week")


precip_streamflow_weekly_diff_data_long <- do.call("rbind", list(diff_ws1_w, diff_ws2_w, diff_ws3_w, diff_ws4_w, diff_ws5_w, diff_ws6_w, diff_ws7_w, diff_ws8_w, diff_ws9_w))

precip_streamflow_weekly_diff_data_long %>% 
  saveRDS(file = "precip_streamflow_weekly_diff_data_long.rds")

save(precip_streamflow_weekly_diff_data_long, file = "precip_streamflow_weekly_diff_data_long.Rdata")
...
load("precip_streamflow_weekly_diff_data_long.RData")
