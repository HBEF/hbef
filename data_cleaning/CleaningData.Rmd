...
lapply_and_save(precip_df_list, renamecolf, "pH", "pH_month", a_name = "_precip_chem")
lapply_and_save(streamflow_df_list, renamecolf, "pH", "pH_month", a_name = "_streamflow_chem")
...
lapply_and_save(precip_df_list, create_water_year_date, 01, a_name = "_precip_chem")
lapply_and_save(streamflow_df_list, create_water_year_date, 01, a_name = "_streamflow_chem")
...
data <- precip_streamflow_data_long %>%
  gather(key, value, pH_month, concentration_mg_month, water_mm_month, concentration_ueq_month,
         concentration_umol_month, flux_month, pH_year, concentration_mg_year, concentration_umol_year,
